        ...
        >
          <div className="md:w-3/5">
            ...
            <p className="py-5">
              ...
              Molestiae velit, officia, eveniet tempora odio sunt quis
              similique, est magnam quas porro beatae obcaecati blanditiis
              perspiciatis id eaque odit consectetur dolore?
            </p>
          </div>
        </motion.div>
